namespace Authentication.Employee
{
	partial class ChangeEmployeeStatus
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ChangeEmployeeStatus));
			...
			this.txtHeader.Text = "Change Employee Status";
			// 
			// Minimize
			// 
			...
			this.Name = "ChangeEmployeeStatus";
